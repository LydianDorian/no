...
harmonic_minor_modes = {
    "whwwhth" : "Harmonic minor",
    "hwwhthw" : "Locrian #6",
    "wwhthwh" : "Ionian #5",
    "whthwhw" : "Dorian #4",
    "hthwhww" : "Phrygian Dominant",
    "thwhwwh" : "Lydian #2",
    "hwhwwht" : "Superlocrian"
...
#would be more efficient if scales can be constructed by following the instructions of whole and half steps etc going through the list of all notes and appending from there
...
C_Harmonicminor  = ["C Harmonic minor ","C","D","D#","F","G","G#","B"] #whwwhth

#Db_Harmonicminor  = need to add all of these
#D_Harmonicminor = 
#E_Harmonicminor=
#Eb_Harmonicminor=
#F_Harmonicminor =
...
#def givenotes(): not working, unit test
    #print("enter scale")
    #scale = sys.stdin.readline().strip()
    #print(scale) #doesnt work
...
while True:
    ...
    #elif int(s) == 5: #give notes of a scale given root and scale
        #givenotes() #doesn't work atm
        

    #elif int(s) == 6: #give steps of scale given scale dictionaries can't be read backwards
